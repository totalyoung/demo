...
public class Solution_1 {
     ...
     *
     * @param s
     * @return 解题思路：先判断最后两个字符是否特殊，如有特殊再减去倒数第二位的值
     */
...
//    }
     ...
     *
     * @param s
     * @return 解题思路：加入栈，如栈中元素数量大于1，则开始判断最后两个是否是括号组合，如是则弹出
     */
     ...
     * @param l1
     * @param l2
     * @return 解题思路：分别比较两个链表的值，小者则添加，如有一个链表先比较完，则直接添加另一个链表
     */
...
//        return slow;
    ...
    public static ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (currA != currB) {
            ...
            currB = currB != null ? currB.next : headB;
        }
        return currA;
//        while(currA!=null){
//            while (currB!=null){
...
//        return null;
    ...
    public static boolean isPalindrome(ListNode head) {
        ...
        while (head != null) {
            if (head.val != pred.val) return false;
            head = head.next;
            pred = pred.next;
        }
        return true;
    ...
    public static void testRunningSum() {
        ...
        ints = runningSum(new int[]{3, 1, 2, 10, 1});
        System.out.println(Arrays.toString(ints));
    }
    ...
    public boolean hasCycle(ListNode head) {
        ListNode next = head;
        while (next != null && (next = next.next) != null && (next = next.next) != null) {
    ...
    public static void testAddTwoNumbers() {
        ListNode listNode = addTwoNumbers(createListNode(new int[]{2, 4, 3}), createListNode(new int[]{5, 6, 4}));
...
//            int a = 118;
//            String b = "UDUUUUUDUDUUDUUUDUUDDUDUUUUDUDDDUDUUUUUDUDDDDDUUDUUDDUUDDUDDDDDU";
//            int[] res = new int[a];
//            int index = 0;
//            int u = index;
//            int d=0;
...
//                    --index;
//                    if(index<0){
//                        index = d = res.length-1;
//                        if(a<count){
//                            u = 0;
//                        }else{
//                            u = index-count+1;
//                        }
//                    }else if(index-d>count-1){
//                        u--;
//                        d--;
//                    }
//                }else{
...
//                            d = index+count-1;
//                        }
//                    }else if(index-u>count-1){
//                        u++;
//                        d++;
//                    }
//                }
////                 System.out.println(u+" "+d+" "+index);
//            }
//            for(int i=u;i<=d;i++){
...
//            System.out.println(index+1);
        testAddTwoNumbers();
//            System.out.println(createListNode(new int[]{1,2,3}));
    }
